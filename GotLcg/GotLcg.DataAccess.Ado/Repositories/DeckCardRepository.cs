...
{
    public sealed class DeckCardRepository : RepositoryBase<DeckCard, DeckCardMapper>, IDeckCardRepository
    {
        public DeckCardRepository(IDbConnection connection, IMapperBootstrap mapperBootstrap)
